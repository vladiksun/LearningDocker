...
kubectl port-forward $(kubectl get pods --namespace default -l "app.kubernetes.io/name=memcached,app.kubernetes.io/instance=memcached" -o jsonpath="{.items[2].metadata.name}") 11213:11211
